 ...
 */?>
<div class="container" ng-app="GoProListApp" ng-controller="listCtrl"> 

<div class="row rcorners " ng-cloak ng-repeat="x in json.vid">
<form novalidate name="form{{ x.id }}" class="simple-form">
...
<script src="https://use.fontawesome.com/f006bf6c27.js"></script>
